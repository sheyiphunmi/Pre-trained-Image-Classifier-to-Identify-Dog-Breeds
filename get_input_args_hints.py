...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg', help = 'Defines the CNN model to use (as vgg)', type = 'str')
    parser.add_argument('--dogfile', default = 'dognames.txt', help = 'Text file with name of dogs', type = 'str' )
