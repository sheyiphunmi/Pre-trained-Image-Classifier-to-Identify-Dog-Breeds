...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # By iterating throught results_dic if labels are found in dognames_dic
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # append (1,0) to the value of  results_dic dictionary 
            #for the key indicated by the variable key 
            #using the extend list function. This indicates
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            #           append (0,1) to the value of the result_dictionary 
            #           for the key indicated by the variable key uisng
