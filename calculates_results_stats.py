...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Number of Labels Match Exactly
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1

        #           counts how many pet images of
...
#             results_stats_dic['n_correct_breed'] += 1  
        ...
        #           Count how many pet images that are NOT dogs were correctly classified.  
        #           This happens when the pet image label indicates the image is-NOT-a-dog 
    ...
    # Calculates % correct for label matches
